...
void render(int width, int height) {
	...
	if (!g_useShader) {
		...
		//glLineWidth(10);
		//glRotatef(45, -1,1,0);
		//cgraCylinder(2,2,10,10,10,false);
		//glTranslatef(0,5,0);
		//cgraSphere(5, 10,10, false);
		...
		//tree.growTree();
//		std::cout << "Should have drawn" << std::endl;
...
int main(int argc, char **argv) {
	...
	// YOUR CODE GOES HERE
	// ...
	std::cout << "The main method is running just before I create a tree" << std::endl;
	tree = new Tree();
	//tree.growTree();
	std::cout << "The main method is running just after I create a tree" << std::endl;
	initLight();
	initTexture();
	initShader();
